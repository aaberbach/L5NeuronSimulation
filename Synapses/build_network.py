...
num_dend_exc = 1#8998 // scale_div
num_apic_exc = 0#1#12380 // scale_div
num_soma_inh = 0#2285 // scale_div

exc_fr_mean = 100#0.1
exc_fr_std = 0#0.5
inh_fr = 0#7 #* scale_div
...
exc_psg.add(node_ids=range(num_exc),
        firing_rate = 2/1000,
        times = (0.2*1000, 1.2*1000))
exc_psg.add(node_ids=range(num_exc),
        firing_rate = 10/1000,
        times = (1.2*1000, 3.2*1000))
